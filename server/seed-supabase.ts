...
async function seed() {
  ...
  const sampleProfiles = [
    ...
    },
    {
      ...
      offered_services: ["Vijveraanleg", "Fonteinen", "Zwemvijvers", "Vijveronderhoud", "Pompsystemen"],
      is_featured: true,
      is_verified: true,
    ...
    },
    {
      ...
      offered_services: ["Pergola's", "Carports", "Tuinhuizen", "Schuttingen", "Overkappingen"],
      is_featured: false,
      is_verified: true,
    ...
    },
    {
      ...
      offered_services: ["Beregeningssystemen", "Druppelirrigatie", "Smart controllers", "Onderhoud", "Winterklaar maken"],
      is_featured: false,
      is_verified: true,
    ...
    },
    {
      ...
      offered_services: ["Gazonaanleg", "Graszoden", "Robotmaaiers", "Bemesting", "Beluchten"],
      is_featured: false,
      is_verified: true,
    ...
    },
    {
      ...
      offered_services: ["Hagen knippen", "Struiken snoeien", "Vormsnoei", "Renovatiesnoei", "Seizoenssnoei"],
      is_featured: true,
      is_verified: true,
    ...
    },
    {
      ...
      offered_services: ["Thermische onkruidbestrijding", "Handmatig wieden", "Mulching", "Preventieve behandeling"],
      is_featured: false,
      is_verified: true,
    ...
    },
    {
      ...
      offered_services: ["Bladruimen", "Winterklaar maken", "Voorjaarsonderhoud", "Composteren", "Tuin opruimen"],
      is_featured: true,
      is_verified: true,
