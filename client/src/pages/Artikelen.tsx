...
import heroArtikelen from "@/assets/images/info-artikelen.jpg";
...
export default function Artikelen() {
  return (
    <InfoPageLayout
      ...
      canonical="/artikelen"
      breadcrumbTitle="Artikelen"
      heroImage={heroArtikelen}
      heroImageAlt="Lees artikelen en tips over tuinonderhoud en tuinaanleg"
      relatedLinks={[
